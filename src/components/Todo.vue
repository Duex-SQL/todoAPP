<template>
    <div class="todo" :class="{ todo__selected : selected }">
        <div class="todo_head" @click="handleClick">
            ...
            <div class="todo_menu"> <i class="fa fa-ellipsis-v" /></div>
        </div>
        ...
        <div class="todo_body">
            ...
            <div class="todo_tasks">
                <h4 class="todo_subtitle" v-if="todayTasks.lengtn">Today</h4>
                <ul>
                 ...
                 <h4 class="todo_subtitle" v-if="tomorrowTasks.lengtn">Tomorrow</h4>
                <ul>
                 ...
                 <h4 class="todo_subtitle" v-if="outdatedTasks.lengtn">Outdate</h4>
                <ul>
...
export default {
    ...
    computed:{
        ...
        progress(){
            ...
            const doneCount = this.todo.tasks.filter( t => !t.delete && t.done).length
